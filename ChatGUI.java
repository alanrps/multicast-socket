...
public class ChatGUI extends javax.swing.JFrame implements UIControl {
    ...
    private void initComponents() {
        ...
        pnlConfiguracao.setBorder(new javax.swing.border.TitledBorder(null, " Configura\u00e7\u00f5es ",
    ...
    private void btnConectarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnConectarActionPerformed
        try {
            ...
            listener.run();
            System.out.println("join: " + criptografia);
            try {
                if (criptografia.equals("sim"))
                    protoController.joinCriptografado();
                else
            ...
            JOptionPane.showMessageDialog(this, uhe.getMessage(), "Erro ao entrar no grupo.",
    ...
    private void btnDesconectarActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            if (protoController != null) {
                try {
                    if (criptografia.equals("sim")){
                        protoController.leaveCriptografado();
                    }else{
     ...
     * @throws InvalidKeyException
     **/
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) throws IOException, InterruptedException {// GEN-FIRST:event_btnEnviarActionPerformed
        ...
        if ((msg.trim().length() > 0) && (lstLista.getSelectedIndex() != -1)) {
            ...
            try {
                if (criptografia.equals("sim")) {
                    ...
                    protoController.sendCriptografado(nickTarget, msg);
                } else{
                    System.out.println("Nada de criptografia: " + criptografia);
